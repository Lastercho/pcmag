...
export PCT_OPTIONS="
  ...
  $PW
"
bash -c "$(wget -qLO - https://github.com/Lastercho/pcmag/raw/master/create_lxc.sh)" || exit

msg_info "Starting LXC Container"
pct start $CTID
msg_ok "Started LXC Container"

lxc-attach -n $CTID -- bash -c "$(wget -qLO - https://github.com/Lastercho/pcmag/raw/master/omada-install.sh)" || exit
